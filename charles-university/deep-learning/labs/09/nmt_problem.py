...
# t2t-datagen --t2t_usr_dir=. --data_dir=t2t_data --problem=sota_lemmatizer
# t2t-trainer --t2t_usr_dir=. --data_dir=t2t_data --problem=sota_lemmatizer --model=transformer --hparams_set=transformer_lemmatizer --output_dir=t2t_train
...
class SotaLemmatizer(text_problems.Text2TextProblem):
    ...
    def generate_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        for word_sent, lemma_sent in zip(train.factors[train.FORMS].word_ids,
                                         train.factors[train.LEMMAS].word_ids):
