...
HVite -T 1 -C configuration/hmm-config -H model/hmm15/macros -H model/hmm15/hmmdefs -S test/test.scp -l '*' -i test/recout.mlf -w test/wdnet.lat -p 0.0 -s 5.0 configuration/voxforge_lexicon_dict train/monophones1
