...
input_node('constraint1','alternative1',0.5,0.49).
input_node('constraint1','alternative2',0.5,0.51).

input_node('constraint2','alternative1',0.5,0.49).
input_node('constraint2','alternative2',0.5,0.51).