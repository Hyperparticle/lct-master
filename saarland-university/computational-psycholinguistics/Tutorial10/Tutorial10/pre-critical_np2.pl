...
input_node('constraint1','alternative1',0,0.66).
input_node('constraint1','alternative2',0,0.66).

input_node('constraint2','alternative1',1,0.33).
input_node('constraint2','alternative2',1,0.33).
