...
input_node('thematic_fit','main_clause',0.2763,5.8).
input_node('thematic_fit','reduced_relative',0.2763,0.6).

input_node('main_clause_bias','main_clause',0.38205,0.92).
input_node('main_clause_bias','reduced_relative',0.38205,0.08).

input_node('verb_tense_voice','main_clause',0.09165,0.495).
input_node('verb_tense_voice','reduced_relative',0.09165,0.5-5).

input_node('by_bias','main_clause',0.25,0.2).
input_node('by_bias','reduced_relative',0.25,0.8).